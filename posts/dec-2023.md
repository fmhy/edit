...
- Separated Tool sections into their own pages: [System Tools](/system-tools),
  ...
  [Text Tools](https://fmhy.net/text-tools),
  [Video Tools](https://fmhy.net/video-tools) and
  [Audio Tools](https://fmhy.net/audio-tools).
...
- Separated Health into subsections: [Mental](/miscguide#mental-health),
  ...
  [Sexual](https://fmhy.net/miscguide#sexual-health) and
  [Detoxing](https://fmhy.net/miscguide#detoxing).
...
- Added sections in Linux for [Video](/linuxguide#linux-video),
  ...
  [File Tools](https://fmhy.net/linuxguide#file-tools).
