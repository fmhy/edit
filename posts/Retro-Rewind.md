...
1. Download [WheelWizard](https://github.com/patchzyy/WheelWizard/releases). 
1. Go to settings, [set the paths](https://ibb.co/WHqWgcb), click save, select home, run the installer, 
