...
1. Open the controller tab, set the [gamecube port](https://i.ibb.co/jTGZdKx/image.png) to your main controller, and the [emulated wiimote](https://i.ibb.co/wYk0R4L/image.png) to your mouse.
