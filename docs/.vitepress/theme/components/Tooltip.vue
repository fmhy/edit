...
<template>
  ...
  >
    <button
      aria-label="Tooltip"
      class="tooltip-trigger text-brand-1 relative inline-flex items-center justify-center leading-none p-0 select-none font-bold cursor-pointer transition-all h-[1.25em] w-[1.25em] mx-[0.1em]"
    >
      <div
        class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1.25em] h-[1.25em] bg-current transition-all"
        :style="{
